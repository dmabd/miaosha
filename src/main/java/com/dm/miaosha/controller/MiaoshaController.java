...
import com.dm.miaosha.Access.AccessLimit;
import com.dm.miaosha.domain.MiaoshaOrder;
import com.dm.miaosha.domain.MiaoshaUser;
import com.dm.miaosha.rabbitmq.MQSender;
import com.dm.miaosha.rabbitmq.MiaoshaMessage;
import com.dm.miaosha.redis.AccessKey;
...
import com.dm.miaosha.service.MiaoshaService;
...
public class MiaoshaController implements InitializingBean{
    ...
    public Result<Integer> miaosha(Model model,MiaoshaUser user,
    	...
    	if(!check) {
    		return Result.error(CodeMsg.REQUST_ILLEGAL);
    	}
    	//内存标记，减少redis访问
